...
describe("Find missing number two lists: ", function() {
  ...
  describe("Case for lists with similar entries and a missing number", function() {
    ...
    it("should return 44 for [40, 49, 58],[44, 49, 58, 40]", function() {
      expect(myApp.findMissing([40, 49, 58],[44, 49, 58, 40])).toEqual(44);
    });

    it("should return 9 for [1, 2, 9, 3],[3, 2, 1]", function() {
      expect(myApp.findMissing([1, 2, 9, 3],[3, 2, 1])).toEqual(9);
    });

    it("should return 19 for [20, 21],[18, 20, 21]", function() {
      expect(myApp.findMissing([20, 21],[18, 20, 21])).toEqual(18);
    });
